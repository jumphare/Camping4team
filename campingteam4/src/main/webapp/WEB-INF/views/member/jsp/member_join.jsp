...
<div class="container" >
  <form class="container1" name="f" method="post" action="member_join_ok.do"
   ...
   <div style="padding:0px; margin: 0 auto; width:200px; height: 200px;">
    <input type="submit" value="회원가입" class="btn btn-success" style="font-size:1.0em;" />
    <input type="reset" value="가입취소" class="btn btn-success" style="font-size:1.0em;"
    onclick="$('#id').focus();" />
   </div>
  </form>
  </div>
